    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            try {
                ...
                System.out.println("Lista de opciones a consultar: ");
                ...
                /* ------------------   */
                System.out.println("--------------------------------");
                System.out.println("Ingrese la opción(número) que desea consultar: ");
            ...
            switch(i) {
                ...
                case 2:
                    ...
                    for(BaseAlumno alumn : listaAlumnos ){
                        if(alumn.getDni().equals(documento)){
                            ...
                            System.out.println("Nombres: " + alumn.getNombre() );
                            System.out.println("Apellidos: " + alumn.getApellidos() );
                ...
                case 3:
                    ...
                    if(listaCreditosAlumno.equals("")){
                        System.out.println("No cuenta con creditos actualmente");
                        System.out.println("--------------------------------");
                        ...
                        if(balumno!= null) {
                            ...
                            if (balumno.getPromedioActual() < 13) {
                                System.out.println("Su promedio de nota es: " + balumno.getPromedioActual());
                        ...
                        System.out.println("El alumno " + respt +" ya cuenta con crédito: " + listaCreditosAlumno);
                    }
